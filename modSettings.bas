...
Global bGettingChanInfo As Boolean

Global bDock            As Boolean
Global strUserProfile   As String
Global INI              As String
Global winINI           As String

'* Input Box stuff
Global strICaption  As String
Global strIText     As String
Global strIDefault  As String
Global strIReturn   As String
...
Global lngClientBack    As Long
Global strBGImage       As String
Global bBGImage         As Boolean
Global bTileImg         As Boolean

'* Windows/interface
Global bFlatButtons     As Boolean
Global bStretchButtons  As Boolean
Global intButtonWidth   As Integer
Global bAlwaysShowST    As Boolean
Global bMinToSystray    As Boolean
Global intTranslucency  As Integer

Enum IFace
    IFT_SIMPLE = 1
    IFT_FANCY = 2
End Enum
Global IFTiface As IFace

'* IRC Settings
Global strQuitMsg       As String
...
Global bNickComplete    As Boolean
Global bShowLag         As Boolean
...
Function InputX(strText As String, Optional strCaption As String = "Input", Optional strDefault As String = "") As String
    strIText = strText
    strICaption = strCaption
    strIDefault = strDefault
    InputBx.Show vbModal
    InputX = strIReturn
End Function
...
Function RealFile(strFileName As String) As String
    Dim intPos As Integer
    intPos = InStrRev(strFileName, "\")
    RealFile = Right(strFileName, Len(strFileName) - intPos)
End Function
